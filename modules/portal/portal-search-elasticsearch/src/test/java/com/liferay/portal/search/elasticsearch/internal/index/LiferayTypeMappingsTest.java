...
public class LiferayTypeMappingsTest {
	...
	public void testPortugueseDynamicTemplatesMatchAnalyzers()
		...
		AnalyzerUtil analyzerUtil = new AnalyzerUtil(
			adminClient, _index.getName());

		analyzerUtil.assertAnalyzer(field_pt, "portuguese");
		analyzerUtil.assertAnalyzer(field_pt_BR, "brazilian");
		analyzerUtil.assertAnalyzer(field_pt_PT, "portuguese");
	}
